...
def jet(hero,unique):
   ...
   while(((Devant+Creature.facing) in theGame().floor) and theGame().floor.get(Devant+Creature.facing)== theGame().floor.ground and i!=0):
   ...
   elif ((Devant+Creature.facing) in theGame().floor) and theGame().floor.get(Devant+Creature.facing)==theGame().floor.ground:
...
class Game(object):
    ...
    equipments = {0: [Equipment("potion", "!", usage=lambda self, hero: heal(hero)), \
                      Equipment("gold", "o"), \
                      Equipment("gum","g", usage=lambda self, hero: jet(hero,True))], \
                  1: [Equipment("potion", "!", usage=lambda self, hero: teleport(hero, True))], \
                  2: [Equipment("bow", usage=lambda self, hero: tir(hero, False))], \
