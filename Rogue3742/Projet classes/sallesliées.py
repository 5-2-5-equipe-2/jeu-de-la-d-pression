    ...
    def moveAllMonsters(self):
        for i in self._elem :
            if isinstance(i,Creature) and not (isinstance(i,Hero)) and self._elem[i].distance(
                ...
                self.hero.meet(i)
            elif type(i) is Creature and self.get(self._elem[i]+self._elem[i].direction(self._elem[self.hero])) in Map.listground:
                if self._elem[i].distance(self._elem[self.hero])<6 :
                    ...
                    if chance == 4:
                        deplacement = random.choice(self.dir)
                ...
                if self._elem[i].distance(self._elem[self.hero])<6 :
                    ...
                    chance = random.randint(1,4)
                    if chance == 4:
                        deplacement = random.choice([Coord(0,-1),Coord(0,1),Coord(1,0),Coord(-1,0)])
                        self.move(i,deplacement)
...
class Game(object):
    ...
    def playthegame(self) -> None:
        ...
        self.fenetre.configure(background="black")
    ...
    def initgraph(self)-> None:
        ...
        self.dicimages={"." : sol_img1,"," : sol_img2,"`" : sol_img3,"´" : sol_img4,"@" : hero_idle,"!" : pot_img,"G" : ted_img,"W":ted_img,"O":ted_img,"B":ted_img,"D":ted_img}
